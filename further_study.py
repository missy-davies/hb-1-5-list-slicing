...
def custom_insert(input_list, index, value):
    ...
    # slice input_list from beginning to index and assign to new list
    # slice input_list from index to the end and assign to new list 2
    # assign value to a value list
    # reassign input_list to new list 1 + value list + new list 2
    For example:
